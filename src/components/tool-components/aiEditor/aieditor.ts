...
import AutoCompletion from "@/components/tool-components/aiEditor/AutoCompletion/AutoCompletion";


class AiEditor extends DecoupledEditor {
}

AiEditor.builtinPlugins = [
    Essentials,
    Paragraph,
    Image,
    ImageCaption,
...
AiEditor.defaultConfig = {};


export async function createAiEditor(element: HTMLElement, config?: any) {
    return await AiEditor.create(element, {
        ...config,
        toolbar: {
            items: [
                'undo', 'redo',
