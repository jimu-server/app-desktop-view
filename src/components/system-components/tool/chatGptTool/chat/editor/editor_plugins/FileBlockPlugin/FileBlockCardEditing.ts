...
import FileBlockCardCommand
    from "@/components/system-components/tool/chatGptTool/chat/editor/editor_plugins/FileBlockPlugin/FileBlockCardCommand";
import EditorFileCard from "@/components/system-components/tool/chatGptTool/chat/editor/widget/EditorFileCard.vue";
