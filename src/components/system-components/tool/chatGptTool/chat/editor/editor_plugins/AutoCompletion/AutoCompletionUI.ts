...
import AutoCompletionView
    , {
    AutoCompletionListItemView
} from "@/components/system-components/tool/chatGptTool/chat/editor/editor_plugins/AutoCompletion/AutoCompletionView";
