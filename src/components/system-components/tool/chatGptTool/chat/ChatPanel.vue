...
import SearchInput from "@/components/system-components/widget/SearchInput.vue";
...
import {
  ...
  ConversationEntity,
  MessageType
} from "@/components/system-components/tool/chatGptTool/chat/model/chat";
import {SendTextMessage} from "@/components/system-components/tool/chatGptTool/gptutil";
